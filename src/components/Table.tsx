    ...
    const fetchTemas = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const formattedData = data.map((leg: Legislacion) => ({ name: leg.ctitulo, type: leg.cnom_archivo, id: leg.eidlegislacion, date: leg.fecha_normativa ? formatDate(leg.fecha_normativa) : null }));
